...
> 状态：**[GO]**  
> 更新原因：商业模式从买断为主切换为订阅制为主，买断/one-time license 作为隐藏选项，Freemium 直接转化  
> 更新日期：2026-07-29
...
| 维度 | 判断 |
|---|---|
| 竞品锚点 | Adobe Acrobat Pro ~$19.99/mo；Smallpdf / iLovePDF 月付 $12，年付折算 ~$7/mo；PDFelement ~$10+/mo。$19 处于月付中低带，与 Acrobat 持平但低于专业套件。 |
| 毛利覆盖 | 按 $0.05/次 × 10 次/月 = $0.50 成本；$19 月费到手约 $17.86（Creem 3.9% + $0.40 后），毛利 > 90%。 |
...
- 年费折算 $8.25/月，与 Smallpdf/iLovePDF 年付区间接近，感知性价比高。
...
| 价格锚点 | 标准价 $79 作为锚点，$59 作为 launch / evergreen 优惠价。 |
| 权益边界 | 与订阅相同：Convert to Word 10 次/月，当前主版本 v1.x 更新，最多 5 台设备。不承诺跨大版本 / 跨平台。 |
...
| Monthly 订阅 | 10 次 / 月 | Top-up：`$5/10 conversions` 或 `$0.50 each` |
| Yearly 订阅 | 10 次 / 月 | 同 Monthly |
| One-time License | 10 次 / 月 | 同 Monthly |

**关键说明：**
- 免费额度 3 次/30 天与 v2 保持一致，基于 `device_id`（fingerprint + IP hash）限制。
- 付费额度 10 次/月覆盖大多数个人/小团队基础需求。
...
| Convert to Word | **仅 3 次/30 天试用** | 订阅 / 买断后 10 次/月，可 Top-up |
...
| 竞品 | 月付 | 年付 | 免费层 | 模式 |
|---|---|---|---|---|
| Adobe Acrobat Pro | ~$19.99/mo | ~$239.88/yr | 7 天试用 | 订阅 |
| Smallpdf | $12/mo | $84/yr（$7/mo） | 每日 2 任务 | 订阅 |
| iLovePDF | $12/mo | $84/yr（$7/mo） | 单文件限制 | 订阅 |
| PDFelement | ~$10+/mo（年付折算） | ~$79–$129/yr | 基础功能免费 | 订阅/买断 |
| Sejda | $7.50/mo（年付） | ~$90/yr | 每日 3 任务 / 200 页 | 订阅/按页 |

**锚点结论：**
- $19/month 作为 Launch Special 月付处于中低带，接近 Acrobat 但低于完整办公套件。
- $99/year 处于竞品年费区间中段，配合 57% off 折扣具备转化吸引力。
- $59 one-time license 在竞品一次性授权（通常 $79–$129）中具备价格优势，同时高于 3 个月月费，避免冲击订阅。
...
| 10 次/月成本 | -$0.50 | -$0.50/月 | -$0.50/月 |
| 固定成本分摊 | -$0.20 | -$0.20/月 | -$0.20/月 |
| 退款损失 | -$0.06 | -$0.21 | -$0.14 |
| **首月毛利** | **$17.10** | — | — |
| **年化毛利（假设留存 12 个月）** | — | **$86.34** | **$47.50** |
...
| Convert to Word | 3 次/30 天 | 10 次/月 | 10 次/月 | 10 次/月 |
...
| 平均订阅用户 | 10 次/月 | $0.50 | $17.86 | $17.36 |
| 重度订阅用户 | 30 次/月 | $1.50 | $17.86 + $10 Top-up | $26.36 |
...
- **FAQ 必须明确**：
  ...
  - 所有付费计划均含 10 次/月 Convert to Word，超出 Top-up。
...
- 已订阅 / 已买断但额度用完：显示 `You’ve used your 10 included conversions this month.`，CTA `Buy 10 more conversions for $5` 或 `$0.50 each`。
...
- [x] 免费版功能与付费版功能边界清晰
- [x] Convert to Word 额度策略清晰（免费 3 次/30 天；付费 10 次/月；超出 Top-up）
...
### 当前结论
- **状态**：[GO] 定价方案本身可推进；**`docs/MVP-NOT-DO.md` §2.3 未同步前，07/08 工程实施仍 [BLOCKED]**
- **一句话结论**：商业模式切换为订阅制为主（月 $19 / 年 $99），$59 one-time license 作为隐藏选项；免费 4 工具不变，Convert to Word 免费 3 次/30 天，订阅/买断均含 10 次/月，超出 Top-up。
